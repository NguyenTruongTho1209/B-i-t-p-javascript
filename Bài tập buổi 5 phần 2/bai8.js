...
// function tinhDinhMuc (input1 , input2){
//     for (let i = 0; i < input1.length; i++) {
//         const khacHang = input1[i];
//         for (let j = 0; j < input2.length; j++) {
//             const loaiHang = input2[j];
//             if(khacHang.phanLoai == loaiHang.Loai){
//                 khacHang.dinhMuc = loaiHang.heSo*khacHang.giohang.trongLuong
//             }
//         }
//     }
//     return input1
...
function tinhDinhMuc (input1 , input2){
    input1.map(function(value){
        for (let i = 0; i < input2.length; i++) {
            ...
            if(value.phanLoai == element.Loai){
                value.dinhMuc = element.heSo*value.giohang.trongLuong
            }
        }
    })
    return input1
...
console.log(55 , tinhDinhMuc(danhSach , phanLoai));
...
//             const loaiHang = input2[j];
//             if(khacHang.phanLoai == loaiHang.Loai){
//                 if(khacHang.dinhMuc >= loaiHang.dinhMuc){
//                     khacHang.uuDai = 'Áp dụng'
//                 }else{
//                     khacHang.uuDai = 'Không áp dụng'
//                 }
//             }
//         }
//     }
...
function uuDai(input1 , input2){
    input1.map(function(value){
        for (let i = 0; i < input2.length; i++) {
            const element = input2[i];
            if(value.phanLoai == element.Loai){
                if(value.dinhMuc >= element.dinhMuc && value.giohang.soLuong >= element.soLuong){
                    value.uuDai = 'Áp Dụng'
                }else{
                    value.uuDai = 'Không Áp Dụng'
                }
            }
        }
    })
...
console.log(75 , uuDai(danhSach , phanLoai));